...
func Delete(sc goservice.ServiceContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		var data blogtagusecase.BlogTagDeleteDTO
		...
		biz := blogtagusecase.NewBlogTagDeleteUseCase(store, blogStore)
		if err := biz.DeleteBlogTag(c.Request.Context(), &data); err != nil {
			panic(err)
		}
